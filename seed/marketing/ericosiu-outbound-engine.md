...
description: Design, analyze, and optimize cold outbound email campaigns for Instantly. Handles end-to-end ICP definition, expert panel scoring (recursive to 90+), sequence copywriting, infrastructure audit, capac…
category: Marketing
sublabel: Strategy
author: Eric Siu
tags: 
