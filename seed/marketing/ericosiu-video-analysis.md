...
description: Analyze YouTube videos or local footage using transcripts first, with silent video checks for demonstrations, delivery, editing, and clip boundaries.
category: Marketing
sublabel: Strategy
author: Eric Siu
tags: 
