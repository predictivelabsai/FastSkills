---
title: Geogrid Analysis
description: When the user wants to analyze local ranking data using geogrid scans, interpret map pack rankings across a geographic area, or understand ARP/ATRP/SoLV metrics.
category: Marketing
sublabel: Local SEO
