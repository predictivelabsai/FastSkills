---
title: Yt Competitive Analysis
description: Analyze YouTube channels for outlier videos and packaging patterns. Identifies what's working (2x+ average views) across any set of channels.
category: Marketing
sublabel: Strategy
author: Eric Siu
tags: 
