---
title: Gbp API Automation
description: When the user wants to programmatically manage Google Business Profiles at scale via API, automate GBP updates, build GBP management tools, or integrate GBP data into their systems.
category: Marketing
sublabel: Local SEO
