...
description: Audit and reorganize a Claude Code / Codex skill library — enforce a naming convention (prefix each skill by which backend or product it touches), rename skills consistently, fix the symlinks and cros…
category: Marketing
sublabel: SEO
author: OpenClaudia
tags: 
