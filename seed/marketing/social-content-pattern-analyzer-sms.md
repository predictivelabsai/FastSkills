...
description: When the user wants to find patterns in what content works and what doesn't. Also use when the user mentions 'what's working,' 'content patterns,' 'best topics,' 'best format,' 'best time to post,' 'a…
category: Marketing
sublabel: Social
author: blacktwist
tags: 
